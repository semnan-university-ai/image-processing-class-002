...
با تابعscaling of brightness مقیاس روشنایی هر تصویر را اندازه میگیرد . در نهایت خروجی تابع prepare  برای محاسبات و تعیین
روشنایی پول ورودی و در نهایت تشخیص آن استفاده میشود .
