...
##### 1. MNIST
<br/>
اين ديتاست در سال 1998 ايجاد شد و يك پايگاه داده بزرگ از ارقام دست نویس انگلیسی است كه بسيار معروف و كاربردي است و معمولا براي آموزش سيستم هاي مختلف
...
<br/>
ديتاست مناسبي براي افرادي ب حساب مي آيد كه مي خواهند تكنيك هاي يادگيري و روش هاي تشخيص الگو را بر روي داده هاي دنياي واقعي امتحان كنند
...
ديتاست CIFAR10 شامل 60000 تصوير رنگي در ابعاد 32*32 است كه در 10 كلاس با 6000 تصوير در هر كلاس دسته بندي 
شده است .
<br/>
...
<br/>
اين ديتاست معمولا براي آموزش الگوريتم هاي يادگيري ماشين و بينايي ماشين استفاده مي شود . از آنجا كه كيفيت تصاوير موجود در اين ديتاست ژايين است 
به محققان اين اجازه را مي دهد تا الگوريتم هاي مختلف را به سرعت امتحان كنند . 
<br/>
انواع مختلففي از شبكه هاي عصبي كانولوشن در تشخيص تصاوير اين ديتاست به كار ميروند . به دليل مشخص بودن دسته بندي هر تصوير (يعني برچسب 
...
ديتاستي است كه نقش بسيار مهمي در زمينه هاي بينايي كامپيوتر مانند تشخيص اشياء موجود ، تعيين ويیگي هاي شي و مشخص كردن 
ارتباط بين اشياء، تشخيص چهره و تخمين وضعيت و ... دارد .
<br/>
 بنابراين از اين ديتاست در آموزش الگوريتم هاي تسخيص اشياء و طبقه بندي اشياء مي توان استفاده كرد.
از بيش از 330000 تصوير تشكيل شده كه بيش از 200000 مورد از آن ها برچسب گذاري شده اند .
<br/>
...
##### 6. Flowers
<br/>
اين ديتاست يك مجموعه داده با 102 دسته بندي مختلف از گل ها تشكيل شده است كه هر دسته بندي 40 تا 258 تصوير را شامل مي شود . .
اين گل ها معمولا در انگلستان يافت مي شوند و در مقياس بزرگ، در ژست هاي مختلف و در نوردهي هاي متفاوت تصويربرداري شده است .
<br/>
...
##### 9. Home Object
<br/>
اين ديتاست شامل اشیاء تصادفی از خانه است. اجسام بیشتر از محیط های آشپزخانه، حمام و اتاق نشیمن گرفته شده اند و 
شامل تصاوير آموزشي و آزمايشي است .
<br/>

##### 10. visualqa = Visual Question Answering
<br/>
اين ديتاست شامل سوالات باز درباره تصاوير است كه پاسخ به اين سوالات نيازمند درك بينش ، زبان و دانش عام است .
<br/>
اين ديتاست شامل بيش از 265000 تصوير و حداقل سه سوال به ازاي هر تصوير مي باشد و به ازاي هر سوال 10 پاسخ درست و 3 پاسخ به احتمال زياد نادرست ارائه شده است.
<br/>
...
##### 16. VisualGenome
<br/>
اين ديتاست براي ارتباط زيان با مفاهيم تصويري ساختار يافته ايجاد شده و بزرگترين مجموعه داده با توصيف تصاوير، اشياء ، ويژگي ها و روابط است .
